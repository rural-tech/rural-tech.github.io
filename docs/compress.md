...
![Lastools Integration compressão de LAS](../assets/images/compress/lastools-convert-laz.png)
...
{:style="text-align:center;"}
![Exportar TIFF com compressão no software Global Mapper](../assets/images/compress/global-mapper-tiff-compression.png)

Para a compressão de arquivos no formato `.tif`, o software
`Lastools Integration` pode ser utilizado:

{:style="text-align:center;"}
![Lastools Integration compressão de TIFF](../assets/images/compress/lastools-compress-tiff.png)
...
{:style="text-align:center;"}
![Compactação de arquivos com 7-Zip](../assets/images/compress/compress-7z.png)
...
{:style="text-align:center;"}
![Propriedades](../assets/images/compress/windows-compression-1.png)

{:style="text-align:center;"}
![Atributos avançados](../assets/images/compress/windows-compression-2.png)
...
{:style="text-align:center;"}
![Propriedades de disco](../assets/images/compress/windows-compression-3.png)
